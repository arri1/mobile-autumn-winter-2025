...
import { Button, TextInput, Text, ActivityIndicator } from "react-native";
    ...
    fetch(`https://jsonplaceholder.typicode.com/posts/${postId}`, {
      ...
      .catch((e) => {
        if (e.name !== "AbortError")
          setPostError(e.message ?? "Error fetching post");
      })
  ...
  return (
    <ThemedView style={styles.container}>
      ...
      <ThemedView style={styles.section}>
        <Text style={styles.title}>Post by Random ID</Text>
        <Text style={styles.text}>Текущий id: {postId ?? "-"}</Text>
      ...
      <ThemedView style={styles.section}>
        ...
        <Text style={styles.text}>Время: {seconds} сек</Text>
        <ThemedView style={styles.buttonContainer}>
          <Button
